...
export const PNG = (props: SVGMotionProps<SVGSVGElement> & PNGProps) => {
    const draw = {
        initial: {
            pathLength: 0,
        },
    ...
    return (
        <motion.svg {...props} width="200" height="241" viewBox="0 0 200 241" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M96.5301 80.47H82.78V94.22H96.5301V80.47Z" fill="#005FAD" />
            ...
            <path d="M96.5301 107.95H82.78V121.7H96.5301V107.95Z" fill="#005FAD" />
            ...
            <path d="M96.5301 135.56H82.78V149.31H96.5301V135.56Z" fill="#005FAD" />
