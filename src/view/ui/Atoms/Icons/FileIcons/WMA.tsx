...
export const WMA = (props: SVGMotionProps<SVGSVGElement> & WMAProps) => {
    const draw = {
        initial: {
            pathLength: 0,
        },
    ...
    return (
        <motion.svg {...props} width="200" height="241" viewBox="0 0 200 241" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                d="M111.66 190.57L104.47 220.64H95.47L90.67 200.52L85.82 220.64H76.82L69.63 190.57H77.54L81.41 212.35L86.69 190.57H94.69L99.97 212.35L103.88 190.57H111.66Z"
                fill="white"
            />
            <path
                d="M149.3 190.78V220.64H142V202L135.53 220.67H129.24L122.73 201.96V220.67H115.45V190.81H124.34L132.47 211.61L140.42 190.81L149.3 190.78Z"
                fill="white"
            />
            <path
                d="M173 215.15H161.68L159.8 220.64H152.15L163.15 190.78H171.53L182.53 220.64H174.79L173 215.15ZM171.13 209.62L167.38 198.57L163.6 209.62H171.13Z"
                fill="white"
            />
            <path
                d="M117.65 131.92H106.7V87.6601C106.7 86.1775 106.111 84.7557 105.063 83.7074C104.014 82.659 102.593 82.0701 101.11 82.0701H73.11C71.6274 82.0701 70.2056 82.659 69.1573 83.7074C68.109 84.7557 67.52 86.1775 67.52 87.6601V131.92H56.52V83.9201C56.5226 80.5191 57.8755 77.2583 60.2813 74.8544C62.6871 72.4504 65.949 71.1001 69.35 71.1001H104.76C108.16 71.1001 111.421 72.4508 113.825 74.855C116.229 77.2592 117.58 80.52 117.58 83.9201L117.65 131.92Z"
                fill="#FF9908"
            />
            <path
                d="M104.67 144.9C111.839 144.9 117.65 139.089 117.65 131.92C117.65 124.751 111.839 118.94 104.67 118.94C97.5013 118.94 91.69 124.751 91.69 131.92C91.69 139.089 97.5013 144.9 104.67 144.9Z"
                fill="#FF9908"
            />
            <path
                d="M54.6 144.9C61.7687 144.9 67.58 139.089 67.58 131.92C67.58 124.751 61.7687 118.94 54.6 118.94C47.4313 118.94 41.62 124.751 41.62 131.92C41.62 139.089 47.4313 144.9 54.6 144.9Z"
                fill="#FF9908"
            />
        </motion.svg>
    );
