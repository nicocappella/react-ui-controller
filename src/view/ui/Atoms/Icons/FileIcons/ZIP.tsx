...
export const ZIP = (props: SVGMotionProps<SVGSVGElement> & ZIPProps) => {
    const draw = {
        initial: {
            pathLength: 0,
        },
    ...
    return (
        <motion.svg {...props} width="200" height="241" viewBox="0 0 200 241" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g opacity="0.3">
                <path
                    opacity="0.3"
                    d="M140.24 49.25C134.772 49.2421 129.53 47.0657 125.665 43.1982C121.799 39.3308 119.625 34.0881 119.62 28.62V0H27.48C20.343 0 13.4984 2.83511 8.45178 7.88171C3.40518 12.9283 0.570007 19.7731 0.570007 26.91V189.13C0.580606 196.26 3.42043 203.094 8.46588 208.132C13.5113 213.17 20.3499 216 27.48 216H138.09C145.22 216 152.059 213.17 157.104 208.132C162.15 203.094 164.989 196.26 165 189.13V49.25H140.24Z"
                    fill="#FF3E4C"
                />
            </g>
            <path
                d="M165 49.25H140.24C134.772 49.2421 129.53 47.0657 125.665 43.1982C121.799 39.3308 119.625 34.0881 119.62 28.62V0L165 49.25Z"
                fill="#FF3E4C"
            />
            <path
